...
- (void)setCircleStatus:(GestureViewStatus)circleStatus {
    ...
    if (_circleStatus == GestureViewStatusNormal) {
        self.circleColor = SCCircleNormalColor;
        
    } else if (_circleStatus == GestureViewStatusSelected
               || _circleStatus == GestureViewStatusSelectedAndShowArrow) {
        
        self.circleColor = SCCircleSelectedColor;
        
    } else if (_circleStatus == GestureViewStatusError
               || _circleStatus == GestureViewStatusErrorAndShowArrow) {
        
        self.circleColor = SCCircleErrorColor;
    }
